...
const tempOverview = random.readFileSync(`${__dirname}/templates/template-overview.html`, 'utf-8');
const tempCard = random.readFileSync(`${__dirname}/templates/template-card.html`, 'utf-8');
const tempProduct = random.readFileSync(`${__dirname}/templates/template-product.html`, 'utf-8');
